...
<body style="background-color: #FCF9E6;">
    ...
    <div class="container w-100">
        <div class="d-flex flex-wrap justify-content-between" style="align-items: center;">
            ...
            <button class="btn-personalizado py-2 px-3" style="font-size: 20px;">Cerrar sesión</button>
        </div>
        <div class="card mx-auto contenedor-login border-0 py-2 px-3" id="tareas">
            <div class="d-flex flex-wrap justify-content-center gap-4" style="position: relative; top: -35px">
                <button class="btn-personalizado btn-toggle px-4 py-2" style="font-size: 22px" onclick="location.href='TareasPendientes.php'">Pendientes</button>
                <button id="completado" class="btn-personalizado btn-toggle px-4 py-2" style="font-size: 22px;">Completadas</button>
            </div>
...
echo $fila['total'];
  ...
  <div id="modalEditarPendientes" class="modal fade">
    ...
    <script>
        let botonInicial = document.getElementById("completado");
        ...
        for(let i=0; i<tareas.length; i++){
            ...
            inputHidden.value = elemento.id;
              ...
              if (btnEditar && btnEditar.getAttribute('data-bs-target') === '#modalEditarPendientes') {
                    ...
                    btnEditar.setAttribute('data-bs-id-tarea', elemento.id);
                }
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    modalEditar.addEventListener('show.bs.modal', function (event) {
       ...
       const tareaID = button.getAttribute('data-bs-id-tarea'); 
